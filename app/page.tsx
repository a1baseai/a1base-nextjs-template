          ...
          <div className="relative w-full max-w-4xl">
            ...
            <div className="mb-16 relative">
              <div className="flex flex-col mb-6">
                ...
                <h2 className="text-2xl font-semibold ml-0 sm:ml-16">
                  Try Your AI Assistant
                </h2>
                <p className="ml-0 sm:ml-16 text-gray-600 dark:text-gray-300">
                  Experience the demo or start building your own AI agent
                </p>
              </div>
              <div className="ml-0 sm:ml-16">
                <div className="flex gap-4 flex-wrap justify-center sm:justify-start">
                  <WhatsAppButton
                    agentNumber={process.env.A1BASE_AGENT_NUMBER}
                  />
                  <Link
                    href="/chat"
              ...
              <div className="flex items-center mb-6">
                ...
                <div className="ml-0 sm:ml-16">
                  <h2 className="text-2xl font-semibold">
                    Update the name & personality of your AI agent
                  </h2>
                ...
                <div className="p-6 rounded-xl bg-white dark:bg-black/20 border border-black/[.08] dark:border-white/[.08] shadow-lg">
                  <div className="flex flex-col gap-3">
                    ...
                    <div className="mt-4">
                      <Link 
                        href="/profile-editor" 
                        className="rounded-lg px-6 py-3 bg-gradient-to-r from-violet-600 to-indigo-600 hover:shadow-lg text-white flex items-center gap-2 transition-all transform hover:-translate-y-1 w-full sm:w-auto justify-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                          <path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path>
                          <path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path>
                        </svg>
                        Use Browser Profile Editor
                      </Link>
                    </div>
                  </div>
                </div>
                ...
                <div className="p-6 rounded-xl bg-gradient-to-br from-purple-50 to-indigo-50 dark:from-purple-900/20 dark:to-indigo-900/20 border border-black/[.08] dark:border-white/[.08] shadow-lg">
                  <div className="flex flex-col items-start">
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-300 mb-4">
                      Give your AI agent the ability to send and receive emails.
                      A1Mail provides dedicated email addresses and simple APIs
                      for email communication.
                    </p>
                    <div className="bg-white dark:bg-black/30 p-4 rounded-lg w-full mb-4">
                      <pre className="text-xs overflow-x-auto">
                        <code>{`// Create an email address for your agent
              ...
              <div className="ml-0 sm:ml-16">
                <div className="p-6 rounded-xl bg-gradient-to-br from-purple-50 to-blue-50 dark:from-purple-900/20 dark:to-blue-900/20 border border-black/[.08] dark:border-white/[.08] shadow-lg">
                  <div className="flex flex-col items-center text-center">
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-300 mb-4">
                      If you find A1Framework helpful, please consider giving us
